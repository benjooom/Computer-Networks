...
def tests_to_run(forwarder):
    ...
    BasicTest.BasicTest(forwarder, "EMPTY")
    RandomDropTest.RandomDropTest(forwarder, "EMPTY")
    BasicTest.BasicTest(forwarder, "rubric")
    RandomDropTest.RandomDropTest(forwarder, "rubric")
    BasicTest.BasicTest(forwarder, "IMG_9006.jpeg")
    RandomDropTest.RandomDropTest(forwarder, "IMG_9006.jpeg")
    SackRandomDropTest.SackRandomDropTest(forwarder, "README")
    SackRandomDropTest.SackRandomDropTest(forwarder, "rubric")
...
class Forwarder(object):
    ...
    def _send(self, packet):
        ...
        self.sock.sendto(str.encode(packet.full_packet), packet.address)
        ...
        try:
            ...
            while sender.poll() is None:
                try:
                    ...
                    self.handle_receive(message.decode(), address, self.current_test.sackMode)
