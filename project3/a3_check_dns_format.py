...
def create (switch_type = RIPRouter):
    ...
    DNSResolver.create('r2', ip_addr = '1.0.0')
...
h2.add_dns_server(h2_domain, "1.0.0")     # h2 -> r2
r2.add_dns_server("com", "10.10.10.103")                # r2 -> h3
h3.add_dns_server(h3_domain, "10.10.10.104")     # h3 -> h4
h4.add_dns_server(h4_domain, "10.10.10.105")     # h4 -> h5
h5.add_dns(h5_host, h5_address, 30.)              # h5 has the host address
h5.add_dns(dummy_host, "192.168.100.2", 30.)      # h5 has dummy address as well
